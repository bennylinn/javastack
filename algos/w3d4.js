class SLL {
    ...
    partition(val) {
      if (!this.contains(val)) {
        ...
        // find first instance of val and set pointer
        var valPointer = this.head;
        while (valPointer != null) {
          if (valPointer.data === val) {
            break
          } 
          valPointer = valPointer.next;
        }
        // if headVal > val, shift head and place after
        while (this.head.data > val) {
          let head = this.head;
          this.head = this.head.next;
          let after = valPointer.next;
          valPointer.next = head;
          head.next = after;
        }
        console.log(this);
        // if num < val place before it else place after
